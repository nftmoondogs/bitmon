    ...
    <>
      ...
      <footer id="foundation" className="text-white py-12 px-8 font-stone">
        <div className="container mx-auto text-center grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          {/* Logo and Title */}
          <div>
            <img src="https://i.ibb.co/sFg8TL0/main-logo-gif.gif" alt="Logo" className="mx-auto mb-4 h-20 w-auto transition duration-300 ease-in-out hover:scale-105" />
            <h2 className="text-3xl font-bold ">$BitMon Token</h2> {/* Apply the flashy class here */}
          </div>
