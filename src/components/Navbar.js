...
export default function Navbar() {
  return (
    <>
      ...
      <nav className="bg-black py-4 font-stone">
        <div className="container mx-auto flex justify-between items-center px-4 xl:px-0">
          <div className="flex items-center">
            <a href="/" className="flex items-center">
              <img src="https://i.ibb.co/sFg8TL0/main-logo-gif.gif" alt="ZERO" className="h-12 mr-3" />
              <h2 className="text-2xl text-white font-bold">$BitMon</h2>
            </a>
          </div>
          <div className="flex items-center">
            {/* Twitter Icon */}
            <a href="https://twitter.com/bitmonsoltoken" target="_blank" rel="noopener noreferrer" className="px-3">
            ...
            {/* Telegram Icon */}
            <a href="https://t.me/bitmonbitcommunity" target="_blank" rel="noopener noreferrer" className="px-3">
              <svg className="social-icon" width="30" height="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
